...
ADAPTERS: dict[str, CliAdapter] = {
    ...
    "codex": CliAdapter(
        ...
        install_hint="Install Codex CLI and ensure the 'codex' command is available.",
        supports_mcp=True,
        supports_mcp_autoconfig=False,
        resume_argument="resume",
        mcp_notes="Manual MCP/tool configuration for Codex CLI.",
    ),
    ...
    "omniroute": CliAdapter(
        id="omniroute",
        label="OmniRoute REPL",
        command_candidates=("omniroute",),
        fallback_command="omniroute",
        install_hint="Install OmniRoute CLI and ensure the 'omniroute' command is available.",
        supports_mcp=True,
        supports_mcp_autoconfig=False,
        resume_argument="repl",
        mcp_notes="OmniRoute CLI supports an interactive multi-turn REPL with LLMs.",
    ),
    "comfy": CliAdapter(
        id="comfy",
        label="Comfy CLI",
        command_candidates=("comfy",),
        fallback_command="comfy",
        install_hint="Install Comfy CLI via 'pip install comfy-cli' and ensure the 'comfy' command is available.",
        supports_mcp=True,
        supports_mcp_autoconfig=False,
        mcp_notes="Comfy CLI drives local ComfyUI and Comfy Cloud workflows.",
    ),
    "copilot": CliAdapter(
        id="copilot",
